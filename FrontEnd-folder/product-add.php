...
include ('../BackEnd-folder/Bakend-Functions/addproduct.php');
...
<body>
       ...
       <hr>
        <form id="product_form" method="post">
			...
			<div class="d-inline-flex align-items-center">
				...
				<select class="form-select" id="type_switcher" name="type_switcher"  style="width: 165px; margin-left: 20px;">
    ...
    // handle type_switcher change event
